...
export const ROUTES = {
  ...
  PAGE_DOCS_ENVIRONMENT_VARIABLES: "/documentation/environment-variables",
  PAGE_DOCS_POSTGRES: "/documentation/postgres",
  PAGE_DOCS_SENTRY: "/documentation/sentry",
  PAGE_DOCS_AUTH0: "/documentation/auth0",
  PAGE_DOCS_GITHUB: "/documentation/github",
  PAGE_DOCS_NETLIFY: "/documentation/netlify",
  PAGE_DOCS_HEROKU: "/documentation/heroku",
